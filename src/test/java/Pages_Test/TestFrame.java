	...
	public void afterMethod(ITestResult result) {
		try {
			if (result.getStatus() == ITestResult.SUCCESS) {
				...
				Markup m = MarkupHelper.createUnorderedList(Arrays.asList(new String[] { "Test Method : " + methodName,
						"Test Description : " + methodDesc, "Test Status : " + "Success!!!" }));
				...
				Markup m = MarkupHelper.createUnorderedList(Arrays.asList(new String[] { "Test Method : " + methodName,
						"Test Description : " + methodDesc, "Test Status : " + "Failed!!!", "Reason : " + remark }));
